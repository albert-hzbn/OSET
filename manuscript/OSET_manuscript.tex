...
grain-size dependence of strength~\citep{hall1951,petch1953}, creep, fatigue, and
...
Hall--Petch effect. This softening was reported experimentally and
...
of single-crystal plasticity. The general idea that deformation in
...
within a factor of $2$--$2.5$; the stresses underlying these last two
comparisons were affected by a since-corrected shear/tensile
conversion error~\citep{sripathi2014}, so the broader,
already-corrected 33-system validation above is the more reliable
cross-material test. The Peierls stress formula of
