...
polymers, or nanocrystals approaching the glass transition,
...
from \OSET\ but \OSET\ does not require dislocations, in our view,
\OSET\ provides a more fundamental and more broadly applicable foundation
...
grain-size dependence of strength~\cite{hall1951,petch1953}, creep, fatigue, and
...
simulation~\cite{hahnpadmanabhan1997,schiotz1998}, because a grain too small to
...
Padmanabhan and Gleiter in an earlier
review~\cite{padgleiter2012} and revisited in the context of
grain/interphase boundary structure~\cite{padgleiter2014}, but in
...
$\tau_0\propto d^{-1/2}$~\cite{pad-part1}, with $d$ throughout this
paper the average grain size, as in~\cite{pad-part1}; $\tau_0$ is therefore
...
Following Eyring~\cite{eyring1935}, who bases his arguments on
...
set. Sripathi and Padmanabhan~\cite{sripathi2014} applied it to 33
...
conversion error~\cite{padsripathihahn2014}, so the broader,
...
cross-checks. The notebook, the figure-generation scripts, and the
\LaTeX\ source of this article and its Supporting Information are
available at \url{https://github.com/albert-hzbn/OSET}.
