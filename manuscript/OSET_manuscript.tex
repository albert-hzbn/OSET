...
this manuscript for language editing and literature search assistance
in the written sections, and for LaTeX formatting and figure generation
scripts. The Python/SymPy derivation notebook
(\url{https://github.com/albert-hzbn/OSET_derivations}) was developed
by the authors; AI tools assisted with code formatting and debugging
but not with any symbolic derivation or numerical result. All scientific
content, theoretical derivations, and results are entirely the authors'
own work.
